    ...
    <div >
        ...
        <div className='flex flex-col text-center gap-[4rem]  absolute top-[3rem] left-[5rem] ' >
          <div>
            ...
            <div className='mt-5 '>
          <Link type="button" className='bg-blue-700  text-white text-sm p-[1rem]  rounded-lg mb-3' to={`${data.id}`} >انتخاب بلیط</Link>
          </div>
          <div className='mt-5'>
            <span className='text-sm text-red-600 mt-[3rem]'> {data.availableSeats} صندلی باقی مانده است</span>
          </div>
