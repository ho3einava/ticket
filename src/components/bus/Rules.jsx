...
export default function Rules() {
 ...
 <Popover
      ...
      content={
        <div className="w-64 text-sm text-gray-500">
          <div className="border-b border-gray-200 bg-gray-100 px-3 py-2 ">
            <h3 id="default-popover" className="font-semibold text-gray-900  ">قوانین جریمه و استرداد</h3>
          </div>
    ...
    >
      <Button className="text-sky-700 bg-gray-100 hover:bg-gray-600 hover:text-white" >قوانین جریمه و استرداد</Button>
    </Popover>
    </div>
  );
}
