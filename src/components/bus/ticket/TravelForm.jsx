  ...
  return (
    <div>
        <div className='  w-[80rem] h-[30rem] bg-gray-200 pt-[5rem] rounded-[5px]' >
            <h3 className='font-bold mr-[3rem] mb-[2rem] text-xl'>اطلاعات سرپرست مسافرین:</h3>
            <form onSubmit={handleSubmit(onSubmit)} className=' relative flex gap-[2rem] justify-start mr-[2rem] flex-wrap '>
            ...
            <button className='border-2 border-solid text-blue-700 border-blue-700 w-[15rem] h-[4rem] rounded-[5px] absolute bottom-[0.25rem] left-[3rem]'>ثبت اطلاعات</button>
            </form>
